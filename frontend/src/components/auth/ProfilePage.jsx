  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div
          className="relative bg-white rounded-xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto animate-[fadeIn_0.3s_ease-out]"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Close button */}
          <button
            onClick={handleClose}
            className="absolute top-4 right-4 z-10 p-2 rounded-full bg-white/90 text-gray-700 hover:bg-gray-200 transition-colors shadow-md"
          ...
          {showSaveSuccess && (
            <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-20 bg-green-100 border border-green-200 text-green-800 px-4 py-2 rounded-lg shadow-md flex items-center">
          ...
          {loading ? (
            ...
            <>
              {/* Profile Header */}
              <div className="bg-gradient-to-r from-green-500 to-green-700 px-8 py-10 rounded-t-xl relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8">
                  <div className="w-28 h-28 rounded-full bg-white flex items-center justify-center text-green-600 font-bold text-3xl shadow-lg ring-4 ring-white/30">
                    {getInitials()}
                  </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      <div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6 text-green-100">
                          ...
                          <div className="flex items-center bg-green-800 bg-opacity-25 px-2 py-0.5 rounded-full">
                      ...
                      {!isEditMode && (
                        <button
                          ...
                          className="hidden md:flex mt-2 md:mt-0 px-3 py-1 bg-white text-green-700 text-sm font-medium rounded-md hover:bg-green-50 transition-all duration-200 items-center shadow-md"
                        >
                  ...
                  <>
                    {activeTab === "personal" && (
                      <div className="bg-white rounded-xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 bg-gray-50 rounded-xl p-6">
                          <div className="space-y-2">
              ...
              {/* Quick Links */}
              {!isEditMode && (
                <div className="px-6 pb-6 md:px-8 md:pb-8 bg-gray-50 border-t border-gray-100 mt-6">
